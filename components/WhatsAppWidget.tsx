...
const WhatsAppWidget = React.memo(() => {
  // Read from environment variables
  const whatsappNumber = process.env.NEXT_PUBLIC_WHATSAPP_NUMBER || '';
  const defaultMessage = process.env.NEXT_PUBLIC_WHATSAPP_MESSAGE ||
    'Hola! Estoy interesado en conocer más sobre Pocion Fire 🔥';
  ...
  return (
    <a
      ...
      className="fixed bottom-8 right-8 z-40
        ...
        bg-primary hover:bg-[#25D366]
        rounded-full flex items-center justify-center
        border border-white/10
        shadow-[0_0_20px_rgba(236,19,19,0.5)]
        hover:shadow-[0_0_25px_rgba(37,211,102,0.6)]
        hover:scale-110 active:scale-95
        transition-all duration-500 ease-out
        animate-luxury-pulse hover:animate-none"
