...
export const PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    notes: {
      top: "Azafrán, Rosa Damascena, Bergamota",
      heart: "Ámbar, Incienso, Cardamomo",
      base: "Madera de Ámbar Carbonizada, Vainilla, Almizcle"
    },
    details: {
      sillage: 75,
      longevity: 85
  ...
  },
  {
    ...
    notes: {
      top: "Incienso, Elemi, Jengibre Negro",
      heart: "Cedro Atlas, Pachulí, Vetiver",
      base: "Vainilla, Ámbar Gris, Musgo de Roble"
    },
    details: {
      sillage: 70,
      longevity: 88
  ...
  },
  {
    ...
    notes: {
      top: "Nuez Moscada, Pimienta Rosa, Cardamomo",
      heart: "Sándalo, Cedro, Canela",
      base: "Resina de Ámbar, Mirra, Tabaco"
    },
    details: {
      sillage: 82,
      longevity: 92
  ...
  },
  {
    ...
    notes: {
      top: "Violeta, Iris, Bergamota",
      heart: "Rosa de Mayo, Jazmín Sambac, Heliotropo",
      base: "Incienso, Ámbar, Almizcle Blanco"
    },
    details: {
      sillage: 65,
      longevity: 78
  ...
  },
  {
    ...
    notes: {
      top: "Pimienta Roja, Clavo de Olor, Naranja Sanguina",
      heart: "Oud Camboyano, Rosa Turca, Ciprés",
      base: "Cuero, Pachulí, Resina de Ámbar"
    },
    details: {
      sillage: 90,
      longevity: 98
  ...
  },
  {
    ...
    notes: {
      top: "Benjuí, Bálsamo de Tolú, Naranja Amarga",
      heart: "Mirra, Olíbano, Estoraque",
      base: "Ámbar, Vainilla Bourbon, Almizcle"
    },
    details: {
      sillage: 78,
      longevity: 90
  ...
  },
  {
    ...
    notes: {
      top: "Menta Glacial, Ozono, Eucalipto",
      heart: "Cedro Blanco, Pino Siberiano, Enebro",
      base: "Ámbar, Almizcle, Cachemira"
    },
    details: {
      sillage: 60,
      longevity: 75
  ...
  },
  {
    ...
    notes: {
      top: "Orquídea Blanca, Freesia, Neroli",
      heart: "Jazmín, Gardenia, Ylang-Ylang",
  ...
  },
  {
    ...
    notes: {
      top: "Mandarina, Limón de Amalfi, Jengibre",
      heart: "Neroli, Azahar, Miel",
      base: "Ámbar, Vainilla, Almizcle Solar"
    },
    details: {
      sillage: 55,
      longevity: 70
  ...
  },
  {
    ...
    notes: {
      top: "Pimienta Negra, Violeta, Cardamomo",
      heart: "Cuero Ruso, Iris, Cipriol",
      base: "Almizcle Oscuro, Patchouli, Tonka"
    },
    details: {
      sillage: 85,
      longevity: 93
